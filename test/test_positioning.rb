...
require_relative "models/item_with_default_scope"
...
class TestInitialisation < Minitest::Test
  ...
  def test_heal_position_with_default_scope
    ...
    first_item = first_list.item_with_default_scope.create name: "First Item"
    second_item = first_list.item_with_default_scope.create name: "Second Item"
    third_item = first_list.item_with_default_scope.create name: "Third Item"

    first_item.update_columns position: 10
    second_item.update_columns position: 15
    third_item.update_columns position: 5

    ItemWithDefaultScope.heal_position_column!
